...
export default function ServiceCard2({ icon, title, subTitle }) {
  return (
    <div className="mx-auto flex  w-full gap-x-4 rounded-2xl bg-white p-4 h-fit md:w-full">
      ...
      <div className="flex h-full w-2/3 flex-col gap-y-2">
        <h4 className="text-main-900 text-[22px] font-bold md:text-2xl">
          {title}
        </h4>
        <p className="text-subTitle md:h-[48px]">{subTitle}</p>
